    ...
    (o.VantaBase = class {
      constructor(e = {}) {
        ...
        if (
          ...
          !(
            ...
            ((a = this.el), (this.el = Object(i.e)(a)), this.el)
          )
        )
      ...
      onMouseMoveWrapper(e) {
        ...
        (t = this.renderer.domElement.getBoundingClientRect()),
          (n = this.mouseX = e.clientX - t.left),
          (i = this.mouseY = e.clientY - t.top),
          n >= 0 &&
            i >= 0 &&
            !this.options.mouseEase &&
            this.triggerMouseMove(n, i);
      }
      ...
      animationLoop() {
        ...
        return (
          ...
          (i = (o = t.top + a) - window.innerHeight),
          (n = o + e),
          this.options.mouseEase &&
    ...
    class s extends i.b {
      ...
      initBasicShader(e = this.fragmentShader, t = this.vertexShader) {
        ...
        return (
          ...
          (i = new THREE.Mesh(new THREE.PlaneGeometry(2, 2), n)),
          this.scene.add(i),
        ...
        for (e in ((t = {}), (n = this.options)))
          (i = n[e]),
            -1 !== e.toLowerCase().indexOf("color")
              ? (t[e] = { type: "v3", value: new THREE.Color(i).toVector() })
